//Character Array
//Print given String with Capitalising First And Last Letter of every word of it.
...
void main()
{
	...
	printf ("\n\nResult after Capitalising First And Last Letter of every word of the given string: \n");
